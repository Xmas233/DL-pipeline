# Description: Contains functionality for creating PyTorch DataLoaders for image classification data.
"""
...
def create_dataloaders(
    ...
    Args:
        train_dir (str): Path to directory containing training data.
        test_dir (str): Path to directory containing test data.
